...
<div class="box-item mb-4">
  <div class="p-3">
    <h3 class="text-warning"><?php echo $info_title; ?></h3>
    ...
    <div class="text-muted">
      ...
      <ul class="list-group d-block d-sm-none">
        <a href="<?php echo $tab_link_1 ?>">
          <li class="list-group-item list-group-item-primary"><?php echo $tab_title_1; ?> <span class="float-right">&raquo;</span></li>
        </a>
        <a href="<?php echo $tab_link_2 ?>">
          <li class="list-group-item list-group-item-info"><?php echo $tab_title_2; ?> <span class="float-right">&raquo;</span></li>
        </a>
        <a href="<?php echo $tab_link_3 ?>">
          <li class="list-group-item list-group-item-warning"><?php echo $tab_title_3; ?> <span class="float-right">&raquo;</span></li>
        </a>
      </ul>
