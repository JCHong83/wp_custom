			...
			if(!empty($data["combo"])){
				if(isset($data["combo"][0])){
					...
					foreach($data["combo"] as $item){					
						...
						$template_combo	.= '<div class="mb-combo-box mb-combo-'.$item_name.$item_index.'-'.str_replace(",","",$combo_data["match_value"]).'" style="'.$style.'">';
					...
					$template_start	.= '<'.$parent_tag.' class="mb-combo-box mb-combo-'.$combo_data["item_name"].$item_index." ".$parent_class.'" style="'.$style.'">';
				...
				if(isset($data["join"][0])){
					...
					foreach($data["join"] as $item){					
						...
						$template_join	.= '<span class="mb-join-box mb-join-'.$item_name.'">';
					...
					$template_start	.= '<'.$parent_tag.' class="mb-join-box mb-join-'.$join_data["item_name"]." ".$parent_class.'" style="'.$style.'">';
